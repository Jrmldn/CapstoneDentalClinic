...
BSIT Capstone 2026 | Alix, Bico, Elefante, Leduna | LPU-Cavite
...
**Auth**
- Supabase Auth; role claim in JWT; middleware guard on every route
...
Deliverables: DB migrations committed · auth passing for all 3 roles · RLS unit-tested · patient portal on dev · zero raw SQL confirmed
...
Deliverables: appointment FSM tested · dental chart CRUD working · staff dashboard live · PDF export correct · role violations return 403
...
Deliverables: notifications firing · chatbot on all intents · CSP/CORS verified · UAT sign-off · zero injection vectors · deployed to Vercel
