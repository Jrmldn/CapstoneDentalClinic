            ...
            return (
              ...
              >
                ...
                <div className="w-full space-y-1">
                  {holiday && (
                    <span className={`text-[9px] font-bold block truncate px-1 rounded uppercase ${
                      holiday.is_special_day ? 'bg-amber-100 text-amber-800' : 'bg-red-100 text-red-800'
                    }`}>
                      {holiday.description}
                    </span>
                  )}
            ...
            <div className="space-y-4 overflow-y-auto max-h-[400px] pr-1">
              ...
              {selectedDetails.holiday && (
                <div className={`p-4 rounded-xl border flex justify-between items-start ${
                  selectedDetails.holiday.is_special_day ? 'bg-amber-50 border-amber-200 text-amber-800' : 'bg-red-50 border-red-200 text-red-850'
                }`}>
                  <div>
