...
export default function AddInventoryModal({ isOpen, onClose, onSuccess, clinicId, categories }: AddInventoryModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      onSuccess()
      setFormData({ name: '', unit: 'pcs', quantity: '', alert_threshold: '5', category_id: '', expiry_date: '' })
      onClose()
    } else {
