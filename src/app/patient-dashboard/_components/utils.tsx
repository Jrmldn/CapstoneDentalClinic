...
export const getStatusBadge = (status: string) => {
  switch (status) {
    ...
    case 'confirmed':
      return <Badge variant="secondary" className="bg-green-100 text-green-700 border-none font-semibold">Confirmed</Badge>
    case 'rescheduled':
      return <Badge variant="secondary" className="bg-blue-100 text-blue-700 border-none font-semibold">Rescheduled</Badge>
    case 'completed':
      return <Badge variant="secondary" className="bg-slate-100 text-slate-700 border-none font-semibold">Completed</Badge>
    case 'cancelled':
