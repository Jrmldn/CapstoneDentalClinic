-- ============================================================
-- PATIENT MERGING (EMAIL FIRST, PHONE FALLBACK) - FIXED TYPE NAMESPACE
-- ============================================================

-- 1. Drop the old trigger and function first
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- 2. Create the function with Email-First, Phone-Fallback logic and qualified type cast
...
BEGIN
  ...
  -- 1. Insert into public.users (explicitly qualify public.user_role enum type)
  INSERT INTO public.users (id, email, role, created_at)
  VALUES (new.id, new.email, v_role::public.user_role, NOW());
